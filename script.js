...
if (event.keyCode === 72) {    //H
  ...
  //backward
  if (event.keyCode === 40) {
    document.getElementById("box").src = "icons/down_on.png";
    // action link
    // location.href = "https://shahriarshafin.me";
  }
  ...
  //left
  if (event.keyCode === 37) {
    document.getElementById("left").src = "icons/leftOn.png";
    // action link
    // location.href = "https://shahriarshafin.me";
  }
  ...
  //right
  if (event.keyCode === 39) {
    document.getElementById("right").src = "icons/rightOn.png";
    // action link
    // location.href = "https://shahriarshafin.me";
...
window.addEventListener('keyup', function (event) {
  ...
  //right
  if (event.keyCode === 39) {
    document.getElementById("right").src = "icons/rightOff.png";
    // action link
    // location.href = "https://shahriarshafin.me";
